...
<div class="container">
    ...
    <div class="control-group <?php echo (form_error('gender')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="gender" class="form-control" id="gender" placeholder="Gender" value="<?php echo set_value('gender'); ?>">
    ...
    <div class="control-group <?php echo (form_error('job_title_th')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="job_title_th" class="form-control" id="job_title_th" placeholder="Thai Job Title" value="<?php echo set_value('job_title_th'); ?>">
    ...
    <div class="control-group <?php echo (form_error('prefix_th')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="prefix_th" class="form-control" id="prefix_th" placeholder="Thai Prefix" value="<?php echo set_value('prefix_th'); ?>">
    ...
    <div class="control-group <?php echo (form_error('prefix_en')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="prefix_en" class="form-control" id="prefix_en" placeholder="English Prefix" value="<?php echo set_value('prefix_en'); ?>">
    ...
    <div class="control-group <?php echo (form_error('first_name_th')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="first_name_th" class="form-control" id="first_name_th" placeholder="Thai First Name" value="<?php echo set_value('first_name_th'); ?>">
    ...
    <div class="control-group <?php echo (form_error('last_name_th')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="last_name_th" class="form-control" id="last_name_th" placeholder="Thai Last Name" value="<?php echo set_value('last_name_th'); ?>">
    ...
    <div class="control-group <?php echo (form_error('first_name_en')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="first_name_en" class="form-control" id="first_name_en" placeholder="English First Name" value="<?php echo set_value('first_name_en'); ?>">
    ...
    <div class="control-group <?php echo (form_error('last_name_en')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="last_name_en" class="form-control" id="last_name_en" placeholder="English Last Name" value="<?php echo set_value('last_name_en'); ?>">
    ...
    <div class="control-group <?php echo (form_error('email1')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="email1" class="form-control" id="email1" placeholder="Email 1" value="<?php echo set_value('email1'); ?>">
    ...
    <div class="control-group <?php echo (form_error('email2')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="email2" class="form-control" id="email2" placeholder="Email 2" value="<?php echo set_value('email2'); ?>">
    ...
    <div class="control-group <?php echo (form_error('other_details')?'has-error':''); ?>">
        ...
        <div class="controls">
            <textarea name="other_details" id="other_details" cols="30" rows="10" placeholder="Other Details" class="form-control"></textarea>
   ...
   <!-- Image -->
    ...
    <br>
        ...
        <div class="control-group <?php echo (form_error('education_extra')?'has-error':''); ?>">
            ...
            <div class="controls">
                <input type="text" name="education_extra" class="form-control" id="education_extra" placeholder="Education Extra" value="<?php echo set_value('education_extra'); ?>">
