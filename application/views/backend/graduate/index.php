...
<div class="container">
    <div class="col-lg-10">
        ...
        <div class="pull-left">
            <div class="btn-toolbar"><a href="<?php echo site_url("admin/graduate/create"); ?>" class="btn btn-primary">
                    <span class="glyphicon glyphicon-plus"></span>&nbsp;Add Graduate </a></div>
        </div>
        <br> <br> <br>
        <?php if(count($staff)){ ?>
        <div class="">
            <table class="table table-striped">
                ...
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    <td>
                        <a href="<?php echo site_url("admin/graduate"); ?>/<?php echo $v["id"]; ?>"
