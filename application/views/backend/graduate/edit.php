...
<div class="container">
    ...
    <form action="<?php echo site_url("admin/graduate"); ?>/<?php echo $staff_item['id'];?>" method="post" enctype="multipart/form-data">
