...
<div class="container">
    ...
    <form action="<?php echo site_url("admin/staff_publication/create"); ?>" method="post">
        <!-- Staff Id -->
        <div class="control-group <?php echo (form_error('staff_id')?'has-error':''); ?>">
            <label class="control-label" for="staff_id">Staff Id</label>
            <div class="controls">
                <input type="text" name="staff_id" class="form-control" id="staff_id" placeholder="Staff Id" value="<?php echo set_value('staff_id'); ?>">
        ...
        <div class="control-group <?php echo (form_error('publication_id')?'has-error':''); ?>">
            ...
            <div class="controls">
                <input type="text" name="publication_id" class="form-control" id="publication_id" placeholder="Publication Id" value="<?php echo set_value('publication_id'); ?>">
