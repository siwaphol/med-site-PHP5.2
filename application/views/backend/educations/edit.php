...
<section class="content-header">
    <h1> Staff Education <small> | Edit Education</small> </h1>
    <ol class="breadcrumb">
...
<div class="container">
    ...
    <form action="<?php echo site_url("admin/staff_educations"); ?>/<?php echo $staff_id; ?>/<?php echo $education['id'];?>" method="post" enctype="multipart/form-data">

    <!-- Year -->
    <div class="control-group <?php echo (form_error('year')?'has-error':''); ?>">
        <label class="control-label" for="year">Year</label>
        <div class="controls">
            <input type="text" name="year" class="form-control" id="year" placeholder="Year" value="<?php echo $education['year'];?>">
    ...
    <div class="control-group <?php echo (form_error('other_details')?'has-error':''); ?>">
        ...
        <div class="controls">
            <input type="text" name="other_details" class="form-control" id="other_details" placeholder="Year" value="<?php echo $education['other_details'];?>">
